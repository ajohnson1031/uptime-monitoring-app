  ...
  index: (data, cb) => {
    if (data.method == "get") {
      const templateData = {
        ...
        "head.description": "We offer free, simple uptime monitoring for HTTP/HTTPS of all kinds. When your site goes down we'll send you a text to let you know.",
        "body.class": "index",
      };
  ...
  accountCreate: (data, cb) => {
    if (data.method == "get") {
      const templateData = {
        ...
        "head.description": "It is easy and only takes a few seconds.",
  ...
  sessionCreate: (data, cb) => {
    if (data.method == "get") {
      const templateData = {
        ...
        "head.description": "Please enter your phone number and phone number to access your account.",
